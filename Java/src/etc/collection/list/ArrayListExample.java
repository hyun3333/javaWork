...
public class ArrayListExample {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 - 배열고 유사한 형태이기 때문에 순차적으로 데이터에 접근하기가 좋다.
...
//		String name = nick[3]; (x) 배열의 방법
		String name = nick.get(3); // 리스트 3번 인덱스
...
//		컬렉션에서 등장 횟수 구하기
		...
		if(Collections.frequency(score, 100) == 3) {
