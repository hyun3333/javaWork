...
public class MainClass {
	...
	public static void main(String[] args) {
        ...
        */
		...
		Calculator cra = new Calculator();
		
		System.out.println("정사각형의 넓이 : " + cra.calcRectArea(5));
		
		System.out.println("직사각형의 넓이 : " + cra.calcRectArea(10, 20));
		
		System.out.println("사다리꼴의 넓이 : " + cra.calcRectArea(5, 13, 7));
