...
/*
 ...
 6.  모든 메서드가 반환값이 잇는 것은 아닙니다. 메서드 실행 후에
    반환할 값이 닥히 없다면 return을 생략해도 됩니다.
 
 7.  return을 생략하고 싶을때는 반환유형을 메서드를 선언할 때 비워두지 마시고
...
//	Quiz. 1
	...
	static double[] calcArrayTotal (int[] nums) {
		...
		return new double[] {total, result};
...
//	6.
	...
	static void divide(int n1, int n2) {
		if(n2 == 0) {
			...
			return; // 보이드에서는 contine와 break를 쓰지못한다 (얘내는 반복문에서만 사용가능)
			        // 보이드에서는 return으로 탈출
		}
		int result = n1 / n2;
